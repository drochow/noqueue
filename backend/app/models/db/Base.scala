...
trait BaseRepositoryQuery[T <: BaseTable[E], E <: BaseEntity] { this: DBComponent =>
  val query: driver.api.type#TableQuery[T]
...
abstract class BaseRepository[T <: BaseTable[E], E <: BaseEntity: ClassTag](clazz: TableQuery[T]) extends BaseRepositoryQuery[T, E] with BaseRepositoryComponent[T, E] { this: DBComponent =>

  val clazzTable: TableQuery[T] = clazz
  lazy val clazzEntity = classTag[E].runtimeClass
  val query: driver.api.type#TableQuery[T] = clazz
